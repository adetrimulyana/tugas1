...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Edit Data User | Difatours</title>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabel Edit User</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form class="form-horizontal" method="POST" action="<?php echo base_url('owner/simpan_edit_user');?>">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8 inputGroupContainer">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input type="Text" class="form-control" name="password" value="<?php echo base64_decode($password);?>">
                        </div>
                      </div>
                    </div>

                    <div class="form-group">
                      <label for="email" class="col-sm-4 control-label">Hak Akses</label>
                      <div class="col-sm-8 inputGroupContainer">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                            <select class="form-control selectpicker" name="hak_akses" >
                              <option><?php echo $hak_akses;?></option>
                              <option >-- Pilih --</option>
