          ...
          <div class="modal-body">
            <!-- Horizontal Form -->
              <div class="box box-info">
                ...
                <!-- form start-->
                <form class="form-horizontal" method="POST" action="<?php echo base_url('owner/simpan_pemeliharaan');?>">
                  <div class="box-body">
          ...
          <div class="modal-body">
            <!-- Horizontal Form -->
              <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="<?php echo base_url('owner/s_type');?>">
                  <div class="box-body">
                    <div class="form-group">
