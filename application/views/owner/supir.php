                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr >
                        ...
                        <th class="text-centert">Type SIM</th>
                    ...
                    <?php foreach ($supir as $a) : ?>
                      <tr class="text-center">
                        ...
                        <a href="<?php echo base_url('Admin/edit_supir/'.$a['id_driver'].'');?>"><button type="button" class="btn btn-xs btn-info"><i class='glyphicon glyphicon-pencil'></i> Edit</button></a> | <button type="button" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-file"></i> Detail</button></td>
                      </tr>
                    <?php endforeach ;?>
                    </tbody>
                  </table>
          ...
          <div class="modal-body">
            <!-- Horizontal Form -->
              <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="<?php echo base_url('owner/simpan_supir');?>">
                  <div class="box-body">
