                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <?php foreach ($tour as $a) : ?>
                      <tr class="text-center">
                        ...
                        <td><a href="<?php echo base_url('Admin/h_tour_paket/'.$a['id_tour'].'');?>"><button type="button" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-trash"></i>  Hapus</button> </a>| <button type="button" class="btn btn-xs btn-info">Edit</button> | <button type="button" class="btn btn-xs btn-info">Detail</button></td>
                      </tr>
                    <?php endforeach ; ?>
                    </tbody>
                    <tfoot>
