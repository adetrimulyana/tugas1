...
<head>
  ...
  <title>Difatours Bandung| Laporan Keuangan</title>
  ...
  <section class="invoice">
    ...
    <div class="col-sm-4 invoice-col">
      ...
      <div class="col-sm-12 invoice-col">
        <h2 class="text-center"><b>LAPORAN KEUANGAN</b></h2>
      </div>
      <!-- /.col -->
    </div>
    <!-- /.row -->
      ...
      <div class="col-xs-12 table-responsive">
        <table class="table table-striped">
          ...
          <tr class="text-center">
                       ...
                       <tr>
                       <?php foreach($laporan_keuangan as $a) :?>
                        <?php if(strtotime("$tgl_awal+$i days") == strtotime ($a['date'])){ ?>
                        <td class="text-center"><?php echo $a['date'];?></td>
                        <td class="text-center"><?php echo $a['kode_resv'];?></td>
                        <td class="text-center"><?php echo $a['nama'];?></td>
                        <td class="text-center"><?php echo "Rp " .number_format($a['payment'], 0, ',', '.');?></td>
                        <td class="text-center"><?php echo "Rp ".number_format($a['discount'], 0, ',', '.');?></td>
                        <td class="text-center"><?php $b=$a['method']; if($b=="1"){ echo " Cash";} else { echo "Transfer";};?></td>
                        <td class="text-center"><?php echo $a['via'];?></td>
                        <?php 
                        }
                        else {continue;}
                        ?>
