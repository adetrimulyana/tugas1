...
<head>
  ...
  <title>Difatours Bandung| Laporan Pemesanan</title>
  ...
  <section class="invoice">
    ...
    <div class="col-sm-4 invoice-col">
      ...
      <div class="col-sm-12 invoice-col">
        <h2 class="text-center"><b>LAPORAN PEMESANAN KENDARAAN</b></h2>
      </div>
      <!-- /.col -->
    </div>
    <!-- /.row -->
        ...
        <table id="example1" class="table table-striped">
                    <thead>
                     ...
                     <?php
                       ...
                       <tr>
                       <?php foreach($laporan_pemesanan as $a) :?>
                        ...
                        <td class="text-center" value="<?php echo $a['id_cust'];?>"><?php echo $a['nama'];?></td>
