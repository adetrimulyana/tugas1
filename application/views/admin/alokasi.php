            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                      ...
                      <?php
                       ...
                       <?php foreach($alokasi as $a) :?>
                        ...
                        <td class="text-center">
                          <a href="<?php echo base_url('Admin/hapus_alokasi/'.$a['kode_resv'].'/'.$a['tgl'].'');?>")><button type="button" class="btn btn-xs btn-danger" onclick="Confirm()"><i class='glyphicon glyphicon-trash'></i> Hapus</button> </a>|
                          <a href="#"><button type="button" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-pencil"></i> Edit</button></a> |
                          <a href="<?php echo base_url('Admin/detail_alokasi/'.$a['kode_resv'].'');?>"><button type="button" class="btn btn-xs btn-success"><i class='glyphicon glyphicon-file'></i>   Detail</button></a>
                        </td>
                         </tr> 
                        <?php endforeach ;?>
                      <?php 
                  ...
                  <a href="<?php echo base_url('Admin/cetak_pemesanan');?>">
                  <button type="button" class="btn btn-info" target="_blank">Cetak</button>
                  </a>
                </div><!-- /.box-body -->
              </div><!-- /.box -->
            </div><!-- /.col -->
