                  ...
                  <table id="type" class="table table-bordered table-striped">
                    ...
                    <?php foreach ($type as $a) : ?>
                      <tr class="text-center">
                        ...
                        <td><a href="<?php echo base_url('Admin/hapus_type_kendaraan/'.$a['harga_sewa'].'');?>"><button type="button" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-trash"></i>  Hapus</button></a> | <a href="<?php echo base_url('Admin/edit_type_kendaraan/'.$a['type'].'');?>"><button type="button" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-pencil"></i>  Edit</button></a></td>
                      </tr>
                    <?php endforeach ;?>
                    </tbody>
                    <tfoot>
          ...
          <div class="modal-body">
            <!-- Horizontal Form -->
              <div class="box box-info">
                ...
                <!-- form start-->
                <form class="form-horizontal" method="POST" action="<?php echo base_url('Admin/simpan_kendaraan');?>">
                  <div class="box-body">
          ...
          <div class="modal-body">
            <!-- Horizontal Form -->
              <div class="box box-info">
                ...
                <!-- form start -->
                <form class="form-horizontal" method="POST" action="<?php echo base_url('Admin/simpan_type_kendaraan');?>">
                  <div class="box-body">
                    <div class="form-group">
                      <label class="col-sm-4 control-label">Type Kendaraan</label>
                      <div class="col-sm-6">
