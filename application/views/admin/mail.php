...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Data Mail | Difatours</title>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabel Data Mail</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr >
                        ...
                        <th class="text-centert">Pax</th>
                        <th class="text-center">Nama Tour</th>
                        <th class="text-center">Tgl Datang</th>
                        <th class="text-centert">Tgl Pulang</th>
                        <th class="text-center">Notes</th>
                        <th class="text-center">Aksi</th>
                    </thead>
                    <tbody>
                    <?php foreach ($mail as $a) : ?>
                      <tr class="text-center">
                        ...
                        <td>
                        <a href="<?php echo base_url('Admin/hapus_mail/'.$a['id'].'');?>")><button type="button" class="btn btn-xs btn-danger" ><i class='glyphicon glyphicon-trash'></i> Hapus</button></a>
                        </td>
                      </tr>
                    <?php endforeach ;?>
                    </tbody>
