...
<html>
  <head>
    <meta charset="UTF-8">
    <title>Edit Data Supir | Difatours</title>
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Tabel Edit Supir</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <form class="form-horizontal" method="POST" action="<?php echo base_url('Admin/simpan_edit_supir');?>">
                  <div class="box-body">

                  <input type="hidden" class="form-control" name="id_driver" placeholder="Nama Cust" value="<?php echo $id_driver ;?>" readonly="">
                      ...
                      <div class="col-sm-8 inputGroupContainer">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input type="Text" class="form-control" name="nama_driver" placeholder="Nama Cust" value="<?php echo $nama_driver ;?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8 inputGroupContainer">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                            <input type="Text" class="form-control" name="alamat" placeholder="Nama Cust" value="<?php echo $alamat ;?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="email" class="col-sm-4 control-label">Type Sim</label>
                      <div class="col-sm-8 inputGroupContainer">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                            <select class="form-control selectpicker" name="type_sim" >
                              <option><?php echo $type_sim ;?></option>
                              <option >-- Pilih --</option>
