      ...
      <div class="col-sm-4 invoice-col">
        ...
        <address>
         <?php foreach($data as $a) :?>
          <strong>Mr/Ms&nbsp&nbsp&nbsp:&nbsp&nbsp<?php echo $a['nama'];?></strong><br>
          Phone&nbsp&nbsp&nbsp&nbsp: <?php echo $a['no_hp'];?><br>
          Email&nbsp&nbsp&nbsp&nbsp&nbsp: <?php echo $a['email'];?><br>
          Country&nbsp: <?php echo $a['negara'];?>
        </address>
      </div>
      <!-- /.col -->
      <div class="col-sm-4 invoice-col">
        <b>Invoice</b><br>
        <br>
        <b>Trip Code&nbsp:&nbsp&nbsp</b><?php echo $a['kode_resv'];?> <br>
        <b>Pax&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp:&nbsp&nbsp</b><?php echo $a['pax'];?><br>
      </div>
