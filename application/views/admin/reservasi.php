                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                      <tr >
                        ...
                        <th class="text-center">Tour Paket</th>
                    ...
                    <?php foreach ($reservasi as $a) : ?>
                      <tr class="text-center">
                        ...
                        <td><?php echo $a['id_tour'];?></td>
                        <td><?php echo $a['notes'];?></td>
                        <td>
                          <a href="<?php echo base_url('Admin/hapus_reservasi/'.$a['kode_resv'].'');?>"><button type="button" class="btn btn-xs btn-danger"><i class="glyphicon glyphicon-trash"></i></button></a> | 
                          <a href="<?php echo base_url('Admin/edit_Reservasi/'.$a['kode_resv'].'');?>"><button type="button" class="btn btn-xs btn-info"><i class="glyphicon glyphicon-pencil"></i></button></a> |
                          <a href="<?php echo base_url('Admin/tambah_reservasi/'.$a['kode_resv'].'');?>"><button type="button" class="btn btn-xs btn-success"><i class="glyphicon glyphicon-file"></i></button></a>
                        </td>
                      </tr>
                    <?php endforeach ;?>
                    </tbody>
          ...
          <div class="modal-body">
            <!-- Horizontal Form -->
              <div class="box box-info">
                ...
                <!-- form start-->
                <form class="form-horizontal" method="POST" action="<?php echo base_url('Admin/simpan_reservasi');?>">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label class="col-sm-4 control-label">Tour Paket</label>
                      <div class="col-sm-6 inputGroupContainer">
                        <div class="input-group">
                          <span class="input-group-addon"><i class="glyphicon glyphicon-list"></i></span>
                            <select class="form-control" name="tour">
                              <option>-- Pilih Tour Paket --</option>
                              <?php foreach ($tour   as $a) : ;?>
                              <option value="<?php echo $a['id_tour'];?>"><?php echo $a['nama'];?></option>
                              <?php endforeach ;?>
                            </select>
                        </div>
                      </div>
